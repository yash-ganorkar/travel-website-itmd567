<%@ Page Title="About" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="About.aspx.cs" Inherits="Travelopedia.About" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
   
     <div class="container">
            <h1 class="page-title"><%: Title %> Us</h1>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-8">
                    <p class="text-bigger">We started to think on a idea which would not be repetitive and be unique on it’s own. We started to look on Google, started to observe the current websites and came to conclusion. We decided to build a website which could allow the users to pay for their transportation. But what’s unique in it and how will it different than the current websites? We came up with an idea of providing an centralized or single application which helps to personalize your trip by picking your favorite place, booking flight tickets, hotels, cars and events and book them all from our application. We decided to add a unique feature of showing and allowing users to get to know what events would be going on during their traveling days. </p>
                </div>
            </div>
            <div class="gap"></div>
        </div>
        <div class="bg-holder">
           ...
           <div class="row row-wrap"  data-gutter="60">
            <div class="col-md-4">
                 <div class="thumb text-center">
                        <header class="thumb-header">
                             <img src="images/prof.jpg" alt="Jason Lambert" title="Professor" class="round"/>
                        </header>
                        <div class="thumb-caption">
                            <h5 class="thumb-title">Jason Lambert</h5>
                            <p class="thumb-meta text-small">Professor</p>
                        </div>
                    </div>
