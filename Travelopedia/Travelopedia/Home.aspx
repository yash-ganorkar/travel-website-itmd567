                               ...
                               <div class="col-md-9">
                                        ...
                                        <div class="col-md-3">
                                            <div class="booking-item-flight-duration">
                                                <p>Duration</p>
                                                <h5><asp:Label ID="xduration1" runat="server"></asp:Label>Mins</h5>
                                            </div>
                                        </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                        ...
                                        <div class="col-md-3">
                                            <div class="booking-item-flight-duration">
                                                <p>Duration</p>
                                                <h5><asp:Label ID="xduration2" runat="server"></asp:Label>Mins</h5>
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                               <div class="col-md-9">
                                        ...
                                        <div class="col-md-3">
                                            <div class="booking-item-flight-duration">
                                                <p>Duration</p>
                                                <h5><asp:Label ID="yduration1" runat="server"></asp:Label>Mins</h5>
                                            </div>
                                        </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                        ...
                                        <div class="col-md-3">
                                            <div class="booking-item-flight-duration">
                                                <p>Duration</p>
                                                <h5><asp:Label ID="yduration2" runat="server"></asp:Label>Mins</h5>
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                        ...
                                        <div class="col-md-3">
                                            <div class="booking-item-flight-duration">
                                                <p>Duration</p>
                                                <h5><asp:Label ID="zduration1" runat="server"></asp:Label>Mins</h5>
                                            </div>
                                        </div>
                            </div>
                                ...
                                <div class="col-md-9">
                                            <div class="booking-item-flight-details">
                                                ...
                                                <div class="booking-item-arrival"><i class="fa fa-plane fa-flip-vertical"></i>
                                                    ...
                                                    <p>Terminal:<asp:Label runat="server" ID="terminal4"></asp:Label></p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="booking-item-flight-duration">
                                                <p>Duration</p>
                                                <h5><asp:Label ID="zduration2" runat="server"></asp:Label>Mins</h5>
                                            </div>
                                        </div>
                            </div>
                        </li>
